export function LegalPage({
  ...
  return (
    <main className="mx-auto w-[min(850px,calc(100%-32px))] py-16">
      ...
      <div className="legal-prose mt-8 text-sm leading-relaxed text-[#52645d] [&_h2]:font-display [&_h2]:mt-8 [&_h2]:text-2xl [&_h2]:text-ink [&_li]:my-1.5 [&_ul]:my-3 [&_ul]:list-disc [&_ul]:pl-5">
        {children}
      </div>
    </main>
  );
